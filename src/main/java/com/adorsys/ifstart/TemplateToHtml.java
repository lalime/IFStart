...
public class TemplateToHtml {
	...
	private String tmplte, dtemplate, dest,nfdest;
	private Map<?, ?> dmodel;
	private Configuration config;
	
	

	public TemplateToHtml(String tmplte, String dtemplate, String dest, Map<?, ?> dmodel, String nfdest) {
		super();
		this.tmplte = tmplte;
	...
	public void generateHtml() throws IOException{
		 System.out.println("Je l'ai fait !");
     ...
     // File output
        ...
        try {
			temp.process(getDmodel(), file);
			 System.out.println("Je l'ai fait : j'ai ecris dans ce fichier ");
			file.flush();
